(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
			...
			var allElementsArr = [f1_headline_text, f2_headline3_text, f2_subhead3_text, f2_cta3_text, f2_headline2_text, f2_subhead2_text, f2_cta2_text, f2_headline1_text, f2_subhead1_text, f2_cta1_text, f2_cta4_text, fg_img, style_img, f1_cta_arrow_img, scroll_scrubber_img, scroll_bar_img, f2_lifestyle5_img, f2_lifestyle5_bg_img, f2_lifestyle6_img, f2_lifestyle4_img, f2_lifestyle4_bg_img, f2_lifestyle3_img, f2_lifestyle1_img, f2_lifestyle1_bg_img, f2_lifestyle2_img, bg_img, logo_bg_color, f1_text_bg_color, f1_bg_color, f2_bg_color, bg_color];
            ...
            function animateElements() {
                var frame_1_in = new TimelineMax()
					...
					if(f1_cta_arrow_img.element){frame_1_in.from(f1_cta_arrow_img.element, 1, {autoAlpha: 0, ease: 'Power1.easeInOut'}, 0.5)};
					...
					if(f1_text_bg_color.element){frame_1_in.from(f1_text_bg_color.element, 0.75, {top: 250, ease: 'Power1.easeInOut'}, 0)};
				...
				var frame_1_out = new TimelineMax()
					...
					if(f1_text_bg_color.element){frame_1_out.to(f1_text_bg_color.element, 0.75, {top: 250, ease: 'Power1.easeInOut'}, 4)};
				...
				var frame_2_in = new TimelineMax()
					if(f2_headline3_text.element){frame_2_in.from(f2_headline3_text.element, 0.75, {left: 300, ease: 'Power1.easeInOut'}, 6)};
					if(f2_subhead3_text.element){frame_2_in.from(f2_subhead3_text.element, 0.75, {left: -105, ease: 'Power1.easeInOut'}, 6)};
					if(f2_cta3_text.element){frame_2_in.from(f2_cta3_text.element, 0.75, {left: 300, ease: 'Power1.easeInOut'}, 6)};
					if(f2_subhead2_text.element){frame_2_in.from(f2_subhead2_text.element, 0.75, {left: 300, ease: 'Power1.easeInOut'}, 3)};
					if(f2_cta2_text.element){frame_2_in.from(f2_cta2_text.element, 0.75, {left: -161, ease: 'Power1.easeInOut'}, 3)};
					if(f2_headline1_text.element){frame_2_in.from(f2_headline1_text.element, 0.75, {left: 300, ease: 'Power1.easeInOut'}, 0)};
					if(f2_subhead1_text.element){frame_2_in.from(f2_subhead1_text.element, 0.75, {left: -103, ease: 'Power1.easeInOut'}, 0)};
					if(f2_cta1_text.element){frame_2_in.from(f2_cta1_text.element, 0.75, {left: 300, ease: 'Power1.easeInOut'}, 0)};
					if(f2_cta4_text.element){frame_2_in.from(f2_cta4_text.element, 1, {autoAlpha: 0, ease: 'Power1.easeInOut'}, 3)};
					if(f2_lifestyle5_img.element){frame_2_in.from(f2_lifestyle5_img.element, 0.75, {left: -134, ease: 'Power1.easeInOut'}, 6)};
					if(f2_lifestyle5_bg_img.element){frame_2_in.from(f2_lifestyle5_bg_img.element, 0.75, {left: -139, ease: 'Power1.easeInOut'}, 6)};
					if(f2_lifestyle6_img.element){frame_2_in.from(f2_lifestyle6_img.element, 0.75, {left: 300, ease: 'Power1.easeInOut'}, 6)};
					if(f2_lifestyle4_img.element){frame_2_in.from(f2_lifestyle4_img.element, 0.75, {left: 300, ease: 'Power1.easeInOut'}, 3)};
					if(f2_lifestyle4_bg_img.element){frame_2_in.from(f2_lifestyle4_bg_img.element, 0.75, {left: 300, ease: 'Power1.easeInOut'}, 3)};
					if(f2_lifestyle3_img.element){frame_2_in.from(f2_lifestyle3_img.element, 0.75, {left: -178, ease: 'Power1.easeInOut'}, 3)};
					if(f2_lifestyle1_img.element){frame_2_in.from(f2_lifestyle1_img.element, 0.75, {left: -133, ease: 'Power1.easeInOut'}, 0)};
					if(f2_lifestyle1_bg_img.element){frame_2_in.from(f2_lifestyle1_bg_img.element, 0.75, {left: -138, ease: 'Power1.easeInOut'}, 0)};
					if(f2_lifestyle2_img.element){frame_2_in.from(f2_lifestyle2_img.element, 0.75, {left: 300, ease: 'Power1.easeInOut'}, 0)};
