    ...
    function Creative(dmo){
        ...
        function init(wrapperID) {
            ...
            var config = {
                ...
                paths: {},
                bundles: {
                    "Rosetta":["core.pack","ad.pack","cnvr.advantage.pack","cnvr.usweb.pack","filters.pack","tweenmax.pack","alignmentgroup.pack", "hammer.pack"]
                }
            };
...
//F2 1 INDEX
          ...
          var f2_lifestyle2_img = R.create("div").set({
            ...
            rosetta:{
              parentNode:f2_bg_color,
              directoryType:"shared",
              tint: R.create("var").set({name:"f2_lifestyle2_img_tint", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value()
            },
            data:{
              hitIndex: 1
            },
...
//CUSTOM
      ...
      //ADDING CTT JUNK VARS
            ...
            function animateElements() {
              ...
              var f2_bg_colorContTop = parseInt(f2_bg_colorCont.top);
...
//HAMMER///////////////////////////////////////////
              ...
              function startHammer(){
                ...
                var trackContTop = parseFloat(f2_bg_colorCont.top);// this
                ...
                function onScrubBg(e) {
                  ...
                  var topStop = "-" + ((parseInt(f2_bg_color.height) - height) + trackContTop);
                  ...
                  if(topCurrent < (topStop - fakeInertia)){
                    TweenMax.to(f2_bg_color.element, .4, {top:topStop, ease:"Bounce.easeOut"});
                                     ...
                                     if(parseFloat(topCurrent) < -148){
                                       //animate in alreadyHitF2Index2
                                       if(!alreadyHitF2Index2) {
                                         f2_index_2_in = new TimelineMax()
                                         f2_index_2_in.to(f2_headline2_text.element,0.75,  {autoAlpha:1, left: 39, ease: 'Power1.easeInOut'},0);
                                         f2_index_2_in.to(f2_subhead2_text.element,0.75, {autoAlpha:1, left: 191, ease: 'Power1.easeInOut'},0);
                                         f2_index_2_in.to(f2_lifestyle4_img.element,0.75,  {autoAlpha:1, left: 169, ease: 'Power1.easeInOut'}, 0);
                                         f2_index_2_in.to(f2_lifestyle4_bg_img.element,0.75, {autoAlpha:1, left: 162, ease: 'Power1.easeInOut'}, 0);
                                         f2_index_2_in.to(f2_lifestyle3_img.element,0.75, {autoAlpha:1, left: 32, ease: 'Power1.easeInOut'}, 0);
                                         f2_index_2_in.to(f2_cta2_text.element,0.75, {autoAlpha:1, left: ctaText2Left, ease: 'Power1.easeInOut'}, 0);
                                         alreadyHitF2Index2 = true;
                                     ...
                                     if(topCurrent < -429){
                                       if(!alreadyHitF2Index3) {
                                         ...
                                         f2_index_3_in.to(f2_headline3_text.element,0.75,  {autoAlpha:1, /*left: 56*/ right:40, ease: 'Power1.easeInOut'},0);
                                         f2_index_3_in.to(f2_subhead3_text.element,0.75, {autoAlpha:1, left: 18, ease: 'Power1.easeInOut'},0);
                                         ...
                                         f2_index_3_in.to(f2_lifestyle6_img.element,0.75, {autoAlpha:1, left: 109, ease: 'Power1.easeInOut'}, 0);
...
//ANIMATE////////////////////////////////////
              ...
              if(f1_lifestyle1_img.element){onOpen.staggerFrom([
                  ...
                  1.5, {autoAlpha: 0, x:0, ease: 'Power1.easeInOut'}, .1, 0)};
              ...
              if(f1_cta_arrow_img.element){onOpen.from(f1_cta_arrow_img.element, 2.5, {autoAlpha: 0, top:"-=10", ease:"Power3.easeInOut"}, 1)};
              ...
              function frame2Anim(){
                ...
                //set props to animate in index3 each index on f2
                TweenMax.set(f2_subhead2_text.element,  {autoAlpha:0, left: 320});
                TweenMax.set(f2_cta2_text.element, {autoAlpha:0, left: -115});
                TweenMax.set(f2_headline2_text.element, {autoAlpha:0, left: -144});
                TweenMax.set(f2_lifestyle3_img.element, {autoAlpha:0, left: -320});
                TweenMax.set(f2_lifestyle4_img.element, {autoAlpha:0, left: 320});
                TweenMax.set(f2_lifestyle4_bg_img.element, {autoAlpha:0, left: 320});
                ...
                if(f2_bg_colorCont.element){frame_2_in.from(f2_bg_colorCont.element, 2, {autoAlpha:0, y:"+=50", ease: 'Power3.easeInOut'},.5)};
                if(f2_bg_color.element){frame_2_in.to(f2_bg_color.element, 1.5, {ease: 'Power3.easeInOut', onComplete:startHammer},1)};
