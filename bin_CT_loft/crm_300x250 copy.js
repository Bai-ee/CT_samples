...
//ANIMATE////////////////////////////////////
              ...
              if(f2_lifestyle4_bg_img.element){frame_2_in.from(f2_cta4_text.element,1, {autoAlpha: 0, ease: 'Power1.easeInOut'}, 2.75)};
                ...
                f2_lifestyle1_img.boxShadow = "1px 1px 5px #000000";
                // f2_lifestyle2_img.boxShadow = "5px 5px 5px #888888";
                // f2_lifestyle3_img.boxShadow = "5px 5px 5px #888888";
                f2_lifestyle4_img.boxShadow ="1px 1px 5px #000000";
                f2_lifestyle5_img.boxShadow = "1px 1px 5px #000000";
                // f2_lifestyle6_img.boxShadow = "5px 5px 5px #888888";
              ...
              //   f2_index_2_in.to(f2_headline3_text.element,0.75,  {autoAlpha:1, left: 52, ease: 'Power1.easeInOut'},0);
              //   f2_index_2_in.to(f2_subhead3_text.element,0.75, {autoAlpha:1, left: 37, ease: 'Power1.easeInOut'},0);
              //   f2_index_2_in.to(f2_lifestyle5_img.element,0.75,  {autoAlpha:1, left: 54, ease: 'Power1.easeInOut'}, 0);
              //   f2_index_2_in.to(f2_lifestyle5_bg_img.element,0.75, {autoAlpha:1, left: 49, ease: 'Power1.easeInOut'}, 0);
              //   f2_index_2_in.to(f2_lifestyle6_img.element,0.75, {autoAlpha:1, left: 127, ease: 'Power1.easeInOut'}, 0);
              //   f2_index_2_in.to(f2_cta3_text.element,0.75, {autoAlpha:1, left: 153, ease: 'Power1.easeInOut'}, 0);
              //   f2_index_2_in.to(f2_cta4_text.element,1, {autoAlpha:1, ease: 'Power1.easeInOut'}, 0);
              //   alreadyHitF2Index2 = true;
              //   var tl2F2Index2 = new TimelineMax()
              //   tl2F2Index2.add(f2_index_2_in)
              // }else {
              //   alreadyHitF2Index3 = true;
              // }
              //set f2 index 2 elements to be off stage
              // TweenMax.set(f2_headline2_text.element,  {autoAlpha:0, left: -320});
              // TweenMax.set(f2_subhead2_text.element, {autoAlpha:0, left: 320});
              // TweenMax.set(f2_lifestyle3_img.element, {autoAlpha:0, left: -182});
              ...
              // TweenMax.set(f2_cta2_text.element, {autoAlpha:0, left: -170});
