...
//ANIMATE////////////////////////////////////
              ...
              if(f2_bg_color.element){frame_2_in.to(f2_bg_color.element, 2, {y: -580, ease: 'Power1.easeInOut', delay:1.75},0)};
              if(f2_bg_color.element){frame_2_in.to(scroll_scrubber_img.element, 2, {top: 430, ease: 'Power1.easeInOut'},2)};
              if(f2_bg_color.element){frame_2_in.to(f2_bg_color.element, 1.5, {y:0, ease: 'Power3.easeInOut', onComplete:startHammer},4)};
              if(f2_bg_color.element){frame_2_in.to(scroll_scrubber_img.element, 1.5, {top: 86, ease: 'Power3.easeInOut', onComplete:pointerEvents},4)};
