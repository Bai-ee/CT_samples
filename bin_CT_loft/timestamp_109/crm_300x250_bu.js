                ...
                function onScrub(e) {
                  if (startScrubY !== null && startScrubY !== undefined) {
                    ...
                    */
                    ...
                    f2_bg_color.top = origScrubTop - ( (percentage * (parseInt(height) + parseInt(origF2BgTop) + 34)));
                    ...
                    // if(parseFloat(scroll_scrubber_img.top) > 136){ // set limit on the left side
                    // }
...
//ANIMATE////////////////////////////////////
              ...
              if(f2_bg_color.element){frame_2_in.to(f2_bg_color.element, 2.5, {autoAlpha:1, y: -260, ease: 'Power3.easeInOut', delay:2})};

              if(f2_bg_color.element){frame_2_in.to(scroll_scrubber_img.element, 2.5, {top: 240, ease: 'Power3.easeInOut', delay:3},0)};
              ...
              if(f2_headline3_text.element){frame_2_in.from(f2_headline3_text.element, 0.75, {left: 320, ease: 'Power1.easeInOut'}, 4)};
              if(f2_subhead3_text.element){frame_2_in.from(f2_subhead3_text.element, 0.75, {left: -115, ease: 'Power1.easeInOut'}, 4)};
              if(f2_lifestyle5_img.element){frame_2_in.from(f2_lifestyle5_img.element, 0.75, {left: -144, ease: 'Power1.easeInOut'}, 4)};
              if(f2_lifestyle5_bg_img.element){frame_2_in.from(f2_lifestyle5_bg_img.element, 0.75, {left: -149, ease: 'Power1.easeInOut'}, 4)};
              if(f2_lifestyle6_img.element){frame_2_in.from(f2_lifestyle6_img.element, 0.75, {left: 320, ease: 'Power1.easeInOut'}, 4)};
              if(f2_cta3_text.element){frame_2_in.from(f2_cta3_text.element, 0.75, {left: 512, ease: 'Power1.easeInOut'}, 4)};
              if(f2_cta4_text.element){frame_2_in.from(f2_cta4_text.element, 1, {autoAlpha: 0, ease: 'Power1.easeInOut'}, 5)};

              if(f2_bg_color.element){frame_2_in.to(f2_bg_color.element, 2, {top:300, ease: 'Power3.easeInOut', onComplete:startHammer},5)};
              if(f2_bg_color.element){frame_2_in.to(scroll_scrubber_img.element, 2, {top: 59, ease: 'Power3.easeInOut', onComplete:pointerEvents},5)};
              ...
              function resetToFrame1() {
                ...
                if(f2_bg_color.element){frame_2_reset.to(f2_bg_color.element, 1, {top:68, ease: 'Power3.easeInOut', autoAlpha:0, onComplete:animateOutFrame2},0)};
                if(f2_bg_color.element){frame_2_reset.to(scroll_scrubber_img.element, 1, {top: 86, ease: 'Power3.easeInOut', autoAlpha:0, onComplete:pointerEvents},0)};
                if(f2_bg_color.element){frame_2_reset.to(scroll_bar_img.element, 1, {autoAlpha:0},0)};
              }
